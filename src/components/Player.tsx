...
export default function Player() {
  ...
  return (
    <div className="w-full max-w-4xl">
      ...
      <div className="glass group relative flex items-center gap-6 rounded-3xl p-5 pr-8">
        {/* Album Art */}
        ...
        <div className="min-w-0 flex-1">
          <p className="truncate text-xl font-bold text-white drop-shadow-sm">{currentSong.title}</p>
          <p className="truncate text-base text-white/60 mt-0.5">{currentSong.artist || currentSong.album}</p>
          <div className="mt-4">
            <div
            ...
            <div className="mt-2 text-left text-sm tabular-nums text-white/50">
